...
function PageLayout(callback, custom, basic) {
    ...
    require(basic || ['pace', 'jquery', 'layui', 'bootstrap'], function () {
        ...
        layui.use(['layer', 'form', 'laydate','element', 'carousel'], function () {
            window.layer = layui.layer, window.form = layui.form, window.laydate = layui.laydate , window.element=layui.element,window.carousel = layui.carousel;
